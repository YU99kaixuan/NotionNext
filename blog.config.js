...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我们提供精准的位置测量, Hi，我们提供载体运动姿态测量,Hi，我们提供无线数据图像传输及信息交换设备、时间同步系统,Hi，我们提供工业控制计算机及周边产品等,欢迎来到我们的产品空间了解详情🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '北京久久凯旋航测科技有限公司', // 您的昵称 例如 tangly1024
